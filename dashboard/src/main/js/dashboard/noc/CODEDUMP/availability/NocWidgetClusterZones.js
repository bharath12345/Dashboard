define(['require', "../../../../dojo/_base/declare", "dojo/i18n", "dijit/TitlePane", "dojox/layout/GridContainer",
    ...
    function (require, declare, i18n, TitlePane, GridContainer, i18nString, NocUtility, NOCCONSTANTS, Logger) {
        ...
        var NocWidgetClusterZones = declare(NOCCONSTANTS.CLASSNAME.WIDGETS.AVAILABILITY.CLUSTERZONES, null, {
            ...
            create:function (data, input) {
                ...
                NocWidgetClusterZones.POSTSET.dataset = [];
                for (var i = 0; i < input.clusterVOs.length; i++) {
                    ...
                    datum.custom = 10;
                    NocWidgetClusterZones.POSTSET.dataset.push(datum);
                }
                ...
                for (var i = 0; i < input.clusterVOs.length; i++) {
                    ...
                    period += NocWidgetClusterZones.CLUSTER_STAGGER_PERIOD;
                    NocWidgetClusterZones.TIMERS.push(timer);
                }
            ...
            periodicCluster:function () {
                var timer = setInterval(dashboard.noc.widgets.availability.NocWidgetClusterZones.prototype.periodicClusterPost,
                    NocWidgetClusterZones.POSTSET.dataset.length * NocWidgetClusterZones.CLUSTER_STAGGER_PERIOD * 1000);
                NocWidgetClusterZones.TIMERS.push(timer);
            },

            periodicClusterPost:function () {
                var clusterDataSet = NocWidgetClusterZones.POSTSET.dataset[NocWidgetClusterZones.CLUSTER_COUNTER];
                ...
                NocWidgetClusterZones.CLUSTER_COUNTER++;
                if (NocWidgetClusterZones.CLUSTER_COUNTER > (NocWidgetClusterZones.POSTSET.dataset.length - 1)) {
                    NocWidgetClusterZones.CLUSTER_COUNTER = 0;
                }
            }
        });

        // static variables of this class
        NocWidgetClusterZones.LOG = Logger.addTimer(new Logger(NOCCONSTANTS.CLASSNAME.WIDGETS.AVAILABILITY.CLUSTERZONES));

        NocWidgetClusterZones.POSTSET = {};
        NocWidgetClusterZones.CLUSTER_COUNTER = 0;
        NocWidgetClusterZones.CLUSTER_STAGGER_PERIOD = 3;

        NocWidgetClusterZones.TIMERS = [];

        return NocWidgetClusterZones;
    });