define(["dojo/_base/declare", "dojo/i18n", "dojo/i18n!dashboard/noc/nls/noc", "dashboard/logger/Logger", "dashboard/noc/NocConstants", "dashboard/noc/NocUtility"],
    ...
    function (declare, i18n, i18nString, Logger, NOCCONSTANTS, NocUtility) {
        ...
        dashboard.classnames.NocWidgetTxGridData = "dashboard.noc.widgets.transaction.NocWidgetTxGridData";

        var NocWidgetTxGridData = declare(dashboard.classnames.NocWidgetTxGridData, null, {
        ...
        NocWidgetTxGridData.LOG = Logger.addTimer(new Logger(dashboard.classnames.NocWidgetTxGridData));


        return NocWidgetTxGridData;
    });