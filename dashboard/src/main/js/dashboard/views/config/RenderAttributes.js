define(["dojo/_base/declare", "dojo/i18n", "dijit/TitlePane", "dojox/layout/GridContainer",
    ...
    "dashboard/logger/Logger", "dashboard/views/config/ConfigView", "dashboard/views/config/ConfigUtility",
    "dojo/i18n!dashboard/views/config/nls/config", "dashboard/helper/ButtonHelper"],
