...
import com.appnomic.appsone.dashboard.viewobject.availability.CompInstanceDataVO;
...
public class AvailabilityDataInstanceNocAction extends AbstractNocAction {
	...
	public AvailabilityDataInstanceNocAction() {
		setDummyData();
	}
