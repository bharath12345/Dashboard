define(['require', "../../../../dojo/_base/declare", "../../dashboard/src/main/js/dojo/i18n", "dojo/i18n!dashboard/noc/nls/noc", "dashboard/logger/Logger", "dashboard/noc/NocConstants", "dashboard/noc/NocUtility"],

    function (require, declare, i18n, i18nString, Logger, NOCCONSTANTS, NocUtility) {

        // this is a completely static class
        var NocWidgetComponentZones = declare(NOCCONSTANTS.CLASSNAME.WIDGETS.COMPONENT.ZONES, null, {
            ...
            create:function (data) {
                ...
                switch(zoneNames.length) {
                    ...
                    case 9:
                        ...
                        break;
                    default:
                        NocWidgetComponentZones.LOG.log(Logger.SEVERITY.SEVERE, "unusual number of zones = "+zoneNames.length);
                        return;
                }

                var gridContainer = new GridContainer({"nbZones": nbZones, isAutoOrganized: true,
                    style: "width: 100%; height: 100%;", "class": "soria"});
                noc.views.NocViewComponent.CP.addChild(gridContainer);
        ...
        NocWidgetComponentZones.LOG = Logger.addTimer(new Logger(NOCCONSTANTS.CLASSNAME.WIDGETS.COMPONENT.ZONES));

        return NocWidgetComponentZones;
    });