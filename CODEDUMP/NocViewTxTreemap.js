define(['require', "../../../dojo/_base/declare", "../dashboard/src/main/js/dojo/i18n", "dojox/layout/GridContainer", "dijit/TitlePane",
    ...
    function (require, declare, i18n, GridContainer, TitlePane, i18nString, NOCCONSTANTS, NocUtility, Logger) {
        ...
        var NocViewTxTreemapPage = declare(NOCCONSTANTS.CLASSNAME.PAGES.TXTREEMAPPAGE, null, {

            loadPage:function () {
                NocViewTxTreemapPage.CP = noc.PageLoader.CpCenter[1];

                var paneWidth = NocViewTxTreemapPage.CP.w/2;
                var halfHeight = NocViewTxTreemapPage.CP.h/2;
                var thirdHeight = NocViewTxTreemapPage.CP.h/3;
                ...
                NocViewTxTreemapPage.CP.addChild(gridContainer);
        ...
        NocViewTxTreemapPage.LOG = Logger.addTimer(new Logger(NOCCONSTANTS.CLASSNAME.PAGES.TXTREEMAPPAGE));

        NocViewTxTreemapPage.PageCounter = 0;

        return NocViewTxTreemapPage;
    });