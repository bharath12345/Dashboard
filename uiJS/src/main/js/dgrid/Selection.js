    ...
    function (kernel, declare, Deferred, on, has, aspect, List, touchUtil, put) {
        ...
        return declare(null, {
            ...
            _selectionEventQueue:function (value, type) {
                ...
                if (rows) {
                    return rows;
                } // return existing queue, allowing to push more
                ...
                setTimeout(this._fireSelectionEvent = function () {
                    if (!rows) {
                        return;
                    } // rows will be set only the first time this is called
                    ...
                    if (trigger) {
                        eventObject.parentType = trigger;
                    }
