 ...
 * Namespace: 
 * Java type: com.appnomic.appsone.ui.extension.application.xmlbeans.FormToolbarType
 *
 ...
 */
public class FormToolbarTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.appnomic.appsone.ui.extension.application.xmlbeans.FormToolbarType
{
    ...
    private static final javax.xml.namespace.QName FORMTOOL$0 = 
        new javax.xml.namespace.QName("", "form-tool");
     ...
     */
    public com.appnomic.appsone.ui.extension.application.xmlbeans.FormToolType[] getFormToolArray()
    {
        synchronized (monitor())
        {
            ...
            com.appnomic.appsone.ui.extension.application.xmlbeans.FormToolType[] result = new com.appnomic.appsone.ui.extension.application.xmlbeans.FormToolType[targetList.size()];
     ...
     */
    public com.appnomic.appsone.ui.extension.application.xmlbeans.FormToolType getFormToolArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.appnomic.appsone.ui.extension.application.xmlbeans.FormToolType target = null;
            target = (com.appnomic.appsone.ui.extension.application.xmlbeans.FormToolType)get_store().find_element_user(FORMTOOL$0, i);
            if (target == null)
            {
     ...
     */
    public void setFormToolArray(com.appnomic.appsone.ui.extension.application.xmlbeans.FormToolType[] formToolArray)
    {
        check_orphaned();
     ...
     */
    public void setFormToolArray(int i, com.appnomic.appsone.ui.extension.application.xmlbeans.FormToolType formTool)
    {
     ...
     */
    public com.appnomic.appsone.ui.extension.application.xmlbeans.FormToolType insertNewFormTool(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.appnomic.appsone.ui.extension.application.xmlbeans.FormToolType target = null;
            target = (com.appnomic.appsone.ui.extension.application.xmlbeans.FormToolType)get_store().insert_element_user(FORMTOOL$0, i);
            return target;
        }
    }
     ...
     */
    public com.appnomic.appsone.ui.extension.application.xmlbeans.FormToolType addNewFormTool()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.appnomic.appsone.ui.extension.application.xmlbeans.FormToolType target = null;
            target = (com.appnomic.appsone.ui.extension.application.xmlbeans.FormToolType)get_store().add_element_user(FORMTOOL$0);
            return target;
        }
    }
