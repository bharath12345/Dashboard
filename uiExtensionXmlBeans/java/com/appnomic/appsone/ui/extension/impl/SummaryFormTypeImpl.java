...
public class SummaryFormTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.appnomic.appsone.ui.extension.SummaryFormType
{
     ...
     */
    public com.appnomic.appsone.ui.extension.FieldGroupType getFieldGroup()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.appnomic.appsone.ui.extension.FieldGroupType target = null;
            target = (com.appnomic.appsone.ui.extension.FieldGroupType)get_store().find_element_user(FIELDGROUP$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setFieldGroup(com.appnomic.appsone.ui.extension.FieldGroupType fieldGroup)
    {
